...
<template>
        <a href="#" class="list-group-item list-group-item-action" @click="handleShowDetails">
            <div class="d-flex justify-content-between align-items-center">
                <img v-if="book.coverImage !== ''" :src="book.coverImage" class="rounded" :alt="'Image of the cover of the book ' + book.title" width="40px">
                <img v-else src="../assets/images/no-cover.jpg" class="rounded" :alt="'Image of the cover of the book ' + book.title" width="40px">
                <h4>{{ book.title }}</h4>
