        ...
        <div class="row">
            <div class="col-10">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="bookSynopsis" rows="4" v-model="modifiedBook.synopsis"></textarea>
                </div>
            </div>
            <div class="col-2">
                ...
                <div class="border d-flex rounded p-2 justify-content-center mt-2">
                    <img v-if="modifiedBook.coverImage !== ''" :src="modifiedBook.coverImage" class="rounded" :alt="'Image of the cover of the book ' + modifiedBook.title" height="133px">
